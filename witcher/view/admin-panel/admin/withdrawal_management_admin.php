                                ...
                                <?php if ($withdrawals_data){
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;direction: ltr    !important;">
                                            <a href="/profile/withdrawals_info?factor_number=<?=$value['factor_number']?>" class="btn btn-primary" style="width: 100%;-webkit-border-radius: 100px;-moz-border-radius: 100px;border-radius: 100px;">بررسی </a>
                                        </td>
                                    </tr>
                                <?php $row_num++;}}?>
                                </tbody>

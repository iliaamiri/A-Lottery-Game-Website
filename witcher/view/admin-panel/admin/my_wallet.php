    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 style="float: right;font-size: 30px;">کیف پول </h2>
                    ...
                    <div class="x_content">
                        ...
                        <a href="/profile/wallet/new" style="margin: 0 auto;text-align: center;padding: 8px 17px;border-radius: 100px;" class="btn btn-success">ساخت کیف پول</a>
                        </div>
                       ...
                       <?php }elseif ($wallet_info['Status']){?>
                                                    <div class="col-md-9 col-sm-9 col-xs-12">

                                                        <div class="profile_title">
                                                            <div class="col-md-6">
                                                                <h2>نمودار تراکنش های کیف پول</h2>
                                                            </div>
                                                            <div class="col-md-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 profile_left" style="direction: rtl!important;">
                                ...
                                <h3><?=$wallet_info['Info']['Person']['First_Name']."  ".$wallet_info['Info']['Person']['Last_Name']?></h3>
                                ...
                                <ul class="list-unstyled user_data">
                                    ...
                                    <li class="m-top-xs">
                                        ...
                                        <a style="font-size: 17px;"><?=$user_info['Email']?></a>
                                    </li>
                                </ul>

                                <a class="btn btn-success" href="/profile/wallet/edit"><i class="fa fa-edit m-right-xs"></i>تغییر مشخصات کیف پول</a>
                                <br />

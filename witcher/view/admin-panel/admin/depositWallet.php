    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 style="float: right;font-size: 30px;">شارژ کیف پول </h2>
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input type="number" min="0" step="100" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="مبلغ را وارد کنید" style="text-align: center;border-radius: 100px;">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12" style="display: block;text-align: center;">
                                        <input id="middle-name" class="btn btn-success" type="submit" name="deposit" value="شارژ" style="border-radius:100px;padding: 7px 24px;font-size: 17px;">
                                    </div>
                                </div>
                            </form>
